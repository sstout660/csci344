...
function changeClass(className) {
  let bodyEl = document.querySelector("body"); // Target body
  bodyEl.classList.remove("ocean", "desert", "high-contrast"); // Remove existing class
  bodyEl.classList.add(className); // Assign new class
}
